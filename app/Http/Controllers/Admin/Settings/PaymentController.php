...
class PaymentController extends Controller
{
    ...
    public function addpaymethod(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Payment Method Saved. vist https://roddytechgroup.com/ for more scripts');
    }
    ...
    public function updatemethod(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Payment Method Updated. vist our website at https://roddytechgroup.com/');
    }
