...
class AppSettingsController extends Controller
{
    ...
    public function updatewebinfo(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Settings Saved successfully. For more scripts like vist our website at https://roddytechgroup.com');
    }
    ...
    public function updatepreference(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Settings Saved successfully. For more scripts vist our website https://roddytechgroup.com/');
    }
