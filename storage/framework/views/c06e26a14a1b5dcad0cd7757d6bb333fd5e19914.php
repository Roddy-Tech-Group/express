...
<head>
    ...
    <link href="<?php echo e(asset('temp/custom/images/rt-favicon.svg')); ?>" rel="shortcut icon">
...
<body class="font-inter bg-gray-50" x-data="{ mobileMenuOpen: false, searchOpen: false }" x-cloak>
    ...
    <div id="preloader" class="fixed inset-0 bg-white z-[9999] flex items-center justify-center" style="-webkit-backdrop-filter: blur(5px); backdrop-filter: blur(5px);">
        <div class="text-center">
            ...
            <div class="w-24 h-24 bg-primary-600 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <img src="<?php echo e(asset('temp/custom/images/rt-favicon.svg')); ?>" alt="Logo" class="w-12 h-12 object-contain animate-bounce rounded-2xl">
            </div>
    ...
    <!-- Main Header -->
    <header class="<?php echo e(request()->routeIs('home') ? 'absolute z-50 top-3 md:top-6 left-3 md:left-6 right-3 md:right-6 pt-4 px-2 md:px-4' : 'bg-white shadow-md z-50 relative'); ?>" style="will-change: transform;">
        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 <?php echo e(request()->routeIs('home') ? '' : 'bg-white'); ?>">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="/" class="flex flex-col items-start leading-none mt-1">
                        <div class="text-2xl font-black italic tracking-tighter">
                            <span class="<?php echo e(request()->routeIs('home') ? 'text-white' : 'text-gray-900'); ?>">Real</span><span class="text-primary-400">Time</span>
                        </div>
                        <div class="text-[9px] tracking-[0.4em] <?php echo e(request()->routeIs('home') ? 'text-white' : 'text-gray-600'); ?> font-bold ml-1 mt-1 opacity-90">
                            LOGISTICS
                        </div>
                    </a>
                </div>
                ...
                <!-- Desktop Navigation -->
                <div class="hidden lg:flex items-center space-x-1 <?php echo e(request()->routeIs('home') ? 'bg-white/10 backdrop-blur-md border border-white/20' : 'bg-gray-100 border border-gray-200'); ?> rounded-xl p-1 shadow-sm">
                    <!-- Home Link -->
                    <a href="/" class="px-5 py-2 text-sm font-semibold rounded-lg transition-all <?php echo e(request()->routeIs('home') ? 'bg-white/20 text-white shadow-sm' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200/60'); ?>">
                        Home
                    </a>
                    
                    <!-- Services Dropdown -->
                    <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        <a href="services" class="px-5 py-2 text-sm font-semibold rounded-lg transition-all flex items-center cursor-pointer <?php echo e(request()->routeIs('home') ? 'text-gray-200 hover:text-white hover:bg-white/5' : (request()->is('services*') || request()->is('diplomatic*') ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200/60')); ?>">
                    ...
                    <!-- Track Link -->
                    <a href="order" class="px-5 py-2 text-sm font-semibold rounded-lg transition-all <?php echo e(request()->routeIs('home') ? 'text-gray-200 hover:text-white hover:bg-white/5' : (request()->is('order*') ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200/60')); ?>">
                        Track
                    </a>

                    <!-- About Link -->
                    <a href="about" class="px-5 py-2 text-sm font-semibold rounded-lg transition-all <?php echo e(request()->routeIs('home') ? 'text-gray-200 hover:text-white hover:bg-white/5' : (request()->is('about*') ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200/60')); ?>">
                        About
                    </a>

                    <!-- FAQ Link -->
                    <a href="faq" class="px-5 py-2 text-sm font-semibold rounded-lg transition-all <?php echo e(request()->routeIs('home') ? 'text-gray-200 hover:text-white hover:bg-white/5' : (request()->is('faq*') ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200/60')); ?>">
                        FAQ
                    </a>

                    <!-- Contact Link -->
                    <a href="contact" class="px-5 py-2 text-sm font-semibold rounded-lg transition-all <?php echo e(request()->routeIs('home') ? 'text-gray-200 hover:text-white hover:bg-white/5' : (request()->is('contact*') ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200/60')); ?>">
                        Contact
                    </a>
                </div>
        ...
        <?php if(Session::has('error') && !request()->routeIs('home')): ?>
...
<?php /**PATH C:\xampp\htdocs\Tim\resources\views/layouts/base.blade.php ENDPATH**/ ?>