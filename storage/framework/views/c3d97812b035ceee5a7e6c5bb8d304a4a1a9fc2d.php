                        ...
                        <div class="flex flex-col md:flex-row">
                            ...
                            <div class="md:w-1/4 mb-6 md:mb-0 md:pr-6">
                                <div class="bg-gray-100 p-2 rounded-lg">
                                    <img src="<?php echo e(asset($courier->photo)); ?>"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const originAddress = <?php echo json_encode($courier->saddress ?? '', 15, 512) ?>;
        const currentAddress = <?php echo json_encode($courier->location ?? '', 15, 512) ?>;
        const destinationAddress = <?php echo json_encode($courier->address ?? '', 15, 512) ?>;
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tim\resources\views/home/track-result.blade.php ENDPATH**/ ?>