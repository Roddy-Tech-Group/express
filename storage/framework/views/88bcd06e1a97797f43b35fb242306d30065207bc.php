...
<?php endif; ?>
                ...
                <div class="mt-2 mb-5 row">
                    <div class="col-12">
                        <di>
                            <a class='btn btn-primary' href='https://roddytechgroup.com/' target='_blank'>
                               Visit our website
                            </a>
                        </di>
...
} elseif ($_instance->childHasBeenRendered('IJBPDJp')) {
    $componentId = $_instance->getRenderedChildComponentId('IJBPDJp');
    $componentTag = $_instance->getRenderedChildComponentTagName('IJBPDJp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IJBPDJp');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('IJBPDJp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tim\resources\views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>