...
} elseif ($_instance->childHasBeenRendered('RpeP4Lx')) {
    $componentId = $_instance->getRenderedChildComponentId('RpeP4Lx');
    $componentTag = $_instance->getRenderedChildComponentTagName('RpeP4Lx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RpeP4Lx');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('RpeP4Lx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\xampp\htdocs\Tim\resources\views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>