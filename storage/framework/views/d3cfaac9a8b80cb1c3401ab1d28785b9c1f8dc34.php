...
<div class="mt-4 mb-5 hero-banner">
    <div class="d-flex align-items-center justify-content-between flex-wrap">
        <div class="mb-3 mb-md-0 position-relative" style="z-index: 10;">
            <h1 class="hero-title">Welcome back, <?php echo e(Auth('admin')->User()->firstName); ?>! 👋</h1>
        ...
        <?php if(Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin'): ?>
            <div class="d-flex position-relative" style="z-index: 10;">
                <a href="<?php echo e(route('admin.shipments.create')); ?>" class="btn-glass mr-2">
                    <i class="fas fa-plus mr-1"></i> New Shipment
                </a>
                <a href="<?php echo e(route('admin.shipments')); ?>" class="btn-glass">
...
<div class="row">
    <div class="col-sm-6 col-md-3 mb-4">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($numberOfUsers)); ?></div>
    ...
    <div class="col-sm-6 col-md-3 mb-4">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($active_users)); ?></div>
    ...
    <div class="col-sm-6 col-md-3 mb-4">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($blockedusers)); ?></div>
    ...
    <div class="col-sm-6 col-md-3 mb-4">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($settings->currency); ?><?php echo e(number_format($total_deposited)); ?></div>
    ...
    <div class="col-xl-7 col-lg-6 mb-4">
        <div class="modern-card h-100">
            <div class="modern-card-header d-flex justify-content-between align-items-center">
                ...
                <span class="text-muted"><i class="far fa-calendar-alt mr-1"></i> <?php echo e(now()->format('Y')); ?></span>
            </div>
            <div class="card-body">
        ...
        <div class="modern-card h-100">
            ...
            <div class="card-body p-0">
                <?php $__empty_1 = true; $__currentLoopData = $latestUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('viewuser', ['id' => $user->id])); ?>" class="activity-feed-item">
                        <div class="activity-icon-box <?php echo e($user->status == 'active' ? 'active' : ($user->status == 'blocked' ? 'blocked' : '')); ?>">
                            <i class="fas fa-box-open"></i>
                        </div>
                        <div class="activity-content">
                            <div class="activity-tracking"><?php echo e($user->trackingnumber ?? 'No Tracking'); ?></div>
                            <div class="activity-email"><?php echo e($user->email); ?></div>
                        </div>
                        <div>
                            ...
                            <?php else: ?>
                                <span class="status-badge status-delivered"><?php echo e(ucfirst($user->status)); ?></span>
                            <?php endif; ?>
                        </div>
                    </a>
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tim\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>