...
<head>
    ...
    <meta property="og:image" content="<?php echo e(($settings->logo ? asset('storage/' . $settings->logo) : asset('default-logo.png'))); ?>">
    
    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(($settings->favicon ? asset('storage/' . $settings->favicon) : asset('default-favicon.png'))); ?>" sizes="any">
...
<?php /**PATH C:\xampp\htdocs\Tim\resources\views/layouts/guest1.blade.php ENDPATH**/ ?>