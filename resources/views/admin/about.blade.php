    ...
    <div class="main-panel">
        <div class="content">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h3 class="fw-bold mb-3">About Roddy Technologies</h3>
                    ...
                    <div class="col-12">
                        <div class="card shadow-lg border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                            <div class="card-body text-center text-white py-5">
                                ...
                                <h1 class="display-4 fw-bold mb-3">Roddy Technologies</h1>
                                ...
                                <div class="d-flex justify-content-center gap-3 flex-wrap">
                                    <a href="https://discord.gg/wQbNxCRuBR" target="_blank" class="btn btn-light btn-lg px-4">
                                        <i class="fab fa-discord me-2"></i>Get Support
                                    </a>
                                    <a href="https://roddytechgroup.com/" target="_blank" class="btn btn-outline-light btn-lg px-4">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    <i class="fab fa-discord fa-2x mb-2 text-dark"></i>
                                                    <h6 class="fw-bold text-dark">Discord Support</h6>
                                                    <a href="https://discord.gg/wQbNxCRuBR" target="_blank" class="btn btn-primary btn-sm">Join Server</a>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    ...
                                                    <a href="https://roddytechgroup.com/" target="_blank" class="btn btn-primary btn-sm">roddytechgroup.com</a>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    ...
                                                    <a href="tel:+237676700173" class="btn btn-primary btn-sm">+237676700173</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
