...
<head>
    ...
    <link rel="shortcut icon" href="{{ $settings->favicon ? asset('storage/'.$settings->favicon) : asset('default-favicon.png') }}" type="image/x-icon">
    <!-- Title -->
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 d-flex justify-content-start ">
                        <!-- Logo Area -->
                        <div class="logo ">
                            <a href="/"><img src="{{ $settings->logo ? asset('storage/'.$settings->logo) : asset('default-logo.png') }}" style="height:50px;" alt=""></a>
                        </div>
