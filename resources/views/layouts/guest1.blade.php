...
<head>
    ...
    <meta property="og:image" content="{{ ($settings->logo ? asset('storage/' . $settings->logo) : asset('default-logo.png')) }}">
    
    <!-- Favicon -->
    <link rel="icon" href="{{ ($settings->favicon ? asset('storage/' . $settings->favicon) : asset('default-favicon.png')) }}" sizes="any">
